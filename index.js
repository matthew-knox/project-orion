...
const events = fs.readdirSync(`../project-orion/events/`).filter(file => file.endsWith('.js'));
...
const messageCommands = fs.readdirSync(`../project-orion/commands/messages/`).filter(files => files.endsWith('.js'));
...
const slashCommands = fs.readdirSync(`../project-orion/commands/interactions/`).filter(files => files.endsWith('.js'));
